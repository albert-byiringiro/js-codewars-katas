const pEl = `The European languages are members of the same family. Their separate existence is a myth. For
...
let words = pEl.toLowerCase().split(/[\s;.,:;</>]+/).filter((word) => word !== "");
let occurrences = {};
...
// sort the occurences from biggest to smallest

let cloudWord = Object.entries(occurrences).sort((a, b) => b[1] - a[1]);


// return 12 first words
console.log(cloudWord.slice(0, 12));